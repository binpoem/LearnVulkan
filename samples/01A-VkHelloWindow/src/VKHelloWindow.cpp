...
VKHelloWindow::VKHelloWindow(uint32_t width, uint32_t height, std::string name) : VKSample(width, height, name) {}
...
void VKHelloWindow::SetupPipeline() { m_initialized = true; }
