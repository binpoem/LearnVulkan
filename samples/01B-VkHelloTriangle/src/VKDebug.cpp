...
void setupDebugMarker(VkDevice device)
{
  pfnDebugMarkerSetObjectTag =
    reinterpret_cast<PFN_vkDebugMarkerSetObjectTagEXT>(vkGetDeviceProcAddr(device, "vkDebugMarkerSetObjectTagEXT"));
...
void endRegion(VkCommandBuffer cmdBuffer)
{
  ...
  if (pfnCmdDebugMarkerEnd) { pfnCmdDebugMarkerEnd(cmdBuffer); }
}
